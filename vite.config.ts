...
function appChunkName(id: string) {
  ...
  if (
    id.includes('/app/features/dashboard/') ||
    id.includes('/app/routes/dashboard/') ||
    id.includes('/app/routes/analytics/')
  ) {
    return 'dashboard'
  }
  ...
  if (
    id.includes('/app/features/pricing/') ||
    id.includes('/app/routes/pricing') ||
    id.includes('/app/routes/checkout')
  ) {
    return 'pricing'
  }
  if (
    id.includes('/app/features/assessment/') ||
    id.includes('/app/features/cv/') ||
    id.includes('/app/routes/assessment') ||
    id.includes('/app/routes/cv')
  ) {
    return 'assessment'
  }
  if (
    id.includes('/app/features/jd/') ||
    id.includes('/app/routes/dashboard/jd') ||
    id.includes('/app/routes/jd-submissions')
  ) {
    return 'jd'
  }
  if (
    id.includes('/app/features/auth/') ||
    id.includes('/app/routes/auth') ||
    id.includes('/app/routes/login') ||
    id.includes('/app/routes/signup')
  ) {
    return 'auth'
  }
