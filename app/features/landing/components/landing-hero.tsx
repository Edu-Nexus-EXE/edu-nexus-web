...
function HeroMockup() {
  ...
  return (
    <div className="relative max-w-5xl mx-auto mt-8 shadow-2xl rounded-xl transition-transform duration-500 hover:scale-[1.01]"
      style={{ perspective: "1000px" }}
    >
      <div className="bg-card rounded-xl border border-border overflow-hidden shadow-2xl relative dark:bg-[#0f172a]">
        ...
        {/* Mockup Content Area */}
        <div className="p-6 md:p-8 grid grid-cols-12 gap-6 bg-card dark:bg-[#0f172a]">
          {/* Sidebar */}
          ...
          <div className="col-span-12 md:col-span-9">
            ...
            <div className="grid grid-cols-3 gap-4 mt-6">
              {(["psychology", "trending_up", "school"] as const).map(
                (icon) => (
                  <div
                    key={icon}
                    className="h-24 bg-muted/30 rounded-lg border border-border p-3"
                  >
