      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-16 items-center'>
          ...
          <div className='order-2 lg:order-1'>
            ...
            <h2 className='text-3xl md:text-4xl font-bold text-foreground mb-4'>{t('featureAnalysis.title')}</h2>
            <p className='text-lg text-muted-foreground mb-6 leading-relaxed'>{t('featureAnalysis.description')}</p>
              ...
              <div className='aspect-video bg-card relative'>
                ...
                <div className='absolute bottom-6 left-6 right-6 bg-card/90 backdrop-blur border border-border p-5 rounded-lg shadow-xl'>
                  <div className='flex justify-between items-center mb-3'>
                    ...
                    <span className='text-xs px-2 py-0.5 bg-destructive/20 text-destructive rounded border border-destructive/20'>
                      -14%
                    </span>
                  </div>
