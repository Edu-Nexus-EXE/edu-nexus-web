      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-16 items-center'>
                ...
                <div className='absolute inset-0 p-8 flex flex-col justify-center'>
                  <div className='relative'>
                    ...
                    <div className='relative pl-10 pb-8'>
                      ...
                      <h4 className='text-primary-foreground font-medium dark:text-foreground'>
                        {t('featureRoadmap.step1')}
                      </h4>
          ...
          <div>
            ...
            <h2 className='text-3xl md:text-4xl font-bold text-foreground mb-4'>{t('featureRoadmap.title')}</h2>
            <p className='text-lg text-muted-foreground mb-6 leading-relaxed'>{t('featureRoadmap.description')}</p>

            <div className='grid grid-cols-2 gap-6 mb-8'>
              <div className='bg-card p-4 rounded-lg border border-border shadow-sm'>
                <span className='block text-2xl font-bold text-foreground mb-1'>{t('featureRoadmap.stat1Value')}</span>
                <span className='text-sm text-muted-foreground'>{t('featureRoadmap.stat1Label')}</span>
              </div>
              <div className='bg-card p-4 rounded-lg border border-border shadow-sm'>
                <span className='block text-2xl font-bold text-foreground mb-1'>{t('featureRoadmap.stat2Value')}</span>
                <span className='text-sm text-muted-foreground'>{t('featureRoadmap.stat2Label')}</span>
              </div>
            </div>
          </div>
        </div>
