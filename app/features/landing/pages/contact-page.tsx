            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-16 items-center w-full'>
              ...
              <div className='bg-card rounded-xl p-10 lg:p-14 shadow-2xl shadow-primary/5 border border-border'>
                ...
                <div className='space-y-6'>
                  {/* Facebook */}
                  <a className='group flex items-center justify-between p-6 rounded-lg bg-muted/50 hover:bg-primary/5 border border-transparent hover:border-primary/20 transition-all duration-300' href='#'>
                    <div className='flex items-center gap-6'>
                      <div className='w-14 h-14 rounded-full bg-[#1877F2]/10 flex items-center justify-center text-[#1877F2]'>
                    ...
                    <span className='material-symbols-outlined text-muted-foreground group-hover:translate-x-2 transition-transform'>arrow_forward</span>
                  </a>
                  ...
                  {/* Email */}
                  <a className='group flex items-center justify-between p-6 rounded-lg bg-muted/50 hover:bg-primary/5 border border-transparent hover:border-primary/20 transition-all duration-300' href='mailto:hello@edu-bridge.vn'>
                    <div className='flex items-center gap-6'>
