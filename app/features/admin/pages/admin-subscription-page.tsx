            ...
            <section className='lg:col-span-4 bg-card rounded-xl border border-border p-8 flex flex-col gap-6 transform hover:-translate-y-1 transition-transform'>
              ...
              <div className='space-y-4'>
                <div className='flex flex-col gap-1.5'>
                  <label className='text-xs font-semibold text-muted-foreground uppercase tracking-widest'>{t('subscriptions.quota')}</label>
                  <input className='w-full bg-muted border-none rounded-lg p-3 text-foreground focus:ring-2 focus:ring-primary' type='number' defaultValue='3' />
                </div>
                <div className='flex flex-col gap-1.5'>
                  <label className='text-xs font-semibold text-muted-foreground uppercase tracking-widest'>{t('subscriptions.roadmap')}</label>
                  <input className='w-full bg-muted border-none rounded-lg p-3 text-foreground focus:ring-2 focus:ring-primary' type='number' defaultValue='1' />
                </div>
                <div className='flex flex-col gap-1.5'>
                  <label className='text-xs font-semibold text-muted-foreground uppercase tracking-widest'>{t('subscriptions.assessment')}</label>
                  <input className='w-full bg-muted border-none rounded-lg p-3 text-foreground focus:ring-2 focus:ring-primary' type='number' defaultValue='2' />
                </div>
                <div className='flex flex-col gap-1.5'>
                  <label className='text-xs font-semibold text-muted-foreground uppercase tracking-widest'>{t('subscriptions.tracking')}</label>
                  <input className='w-full bg-muted border-none rounded-lg p-3 text-foreground focus:ring-2 focus:ring-primary' type='number' defaultValue='1' />
                </div>
              </div>
              ...
              <div className='space-y-4'>
                <div className='flex flex-col gap-1.5'>
                  ...
                  <div className='relative'>
                    <input className='w-full bg-muted border-none rounded-lg p-3 text-primary font-bold focus:ring-2 focus:ring-primary' type='number' defaultValue='-1' />
                    <span className='absolute right-3 top-1/2 -translate-y-1/2 text-[10px] text-muted-foreground opacity-60'>{t('subscriptions.unlimited')}</span>
                  </div>
                </div>
                <div className='flex flex-col gap-1.5'>
                  <label className='text-xs font-semibold text-muted-foreground uppercase tracking-widest'>{t('subscriptions.roadmap')}</label>
                  <input className='w-full bg-muted border-none rounded-lg p-3 text-foreground focus:ring-2 focus:ring-primary' type='number' defaultValue='10' />
                </div>
                <div className='flex flex-col gap-1.5'>
                  <label className='text-xs font-semibold text-muted-foreground uppercase tracking-widest'>{t('subscriptions.assessment')}</label>
                  <input className='w-full bg-muted border-none rounded-lg p-3 text-foreground focus:ring-2 focus:ring-primary' type='number' defaultValue='50' />
                </div>
                <div className='flex flex-col gap-1.5'>
                  <label className='text-xs font-semibold text-muted-foreground uppercase tracking-widest'>{t('subscriptions.tracking')}</label>
                  <input className='w-full bg-muted border-none rounded-lg p-3 text-foreground focus:ring-2 focus:ring-primary' type='number' defaultValue='5' />
                </div>
              </div>
              ...
              <div className='bg-primary/5 rounded-2xl p-12 flex flex-col md:flex-row items-center gap-12 border border-primary/10'>
                <div className='flex-1'>
                  <h2 className='text-2xl font-bold mb-4 text-foreground'>
                    {t('subscriptions.alertTitle')}
                  </h2>
                  <p className='text-muted-foreground mb-6 leading-relaxed'>
                    {t('subscriptions.alertDesc')}
                  </p>
                ...
                <div className='w-full md:w-1/3 aspect-video rounded-xl overflow-hidden shadow-2xl border border-border'>
                  <img alt='Data visualization dashboard' className='w-full h-full object-cover' src='https://lh3.googleusercontent.com/aida-public/AB6AXuB7Gd0DljP-yMJau-ILUGTWiO6koprx72UQSfBBE5jssUGEXW2ZU6bt4yfl3Uxgs4M_w_5PDsUr1ClzVDMAmN2FMjpFvbAAt819SMbsq9JZRZGq45nRelko37rzTGvgu_Hz-s6mHU-V1AY-VhQWonLZvB-9QPmqsy6L7FcQfONMcQrRq3V7W-qUFdsAVxhnkRRXuRSnKw5iEg1uxJ133wkUsi6E8rCOduyhZqeqw6sW2nFq6fZ9P0dr5QoYQva13arbjdIXe1cKekKz' />
                </div>
              </div>
            </div>
