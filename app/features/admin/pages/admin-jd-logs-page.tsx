        ...
        <div className='p-8 max-w-7xl mx-auto w-full space-y-8'>
          ...
          <section className='bg-card p-6 rounded-xl space-y-4 border border-border shadow-sm'>
            <div className='grid grid-cols-1 md:grid-cols-4 gap-4'>
              ...
              <div className='relative'>
                <span className='material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground'>filter_list</span>
              ...
              <div className='relative'>
                <span className='material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground'>calendar_today</span>
                <input
                  className='w-full pl-10 pr-4 py-3 bg-muted border-none ring-1 ring-border focus:ring-2 focus:ring-primary/50 rounded-lg text-foreground'
                  type='date'
                />
          ...
          <div className='bg-card rounded-xl overflow-hidden shadow-sm border border-border'>
              ...
              <table className='w-full text-left border-collapse'>
                <thead>
                  <tr className='bg-muted'>
                    ...
                    <th className='px-6 py-4 font-bold text-xs text-muted-foreground uppercase tracking-wider'>{t('jdLogs.table.source')}</th>
                ...
                <tbody className='divide-y divide-border'>
                  ...
                  <tr className='hover:bg-muted/50 transition-colors'>
                    ...
                    <td className='px-6 py-4 text-right space-x-1'>
                      ...
                      <button className='p-2 hover:bg-muted rounded-lg text-muted-foreground transition-colors' title={t('jdLogs.actions.retry')}>
                        <span className='material-symbols-outlined'>refresh</span>
                      </button>
                      <button className='p-2 hover:bg-destructive/10 rounded-lg text-destructive transition-colors' title={t('jdLogs.actions.delete')}>
            ...
            <div className='px-6 py-4 bg-muted flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-border'>
              <span className='text-sm text-muted-foreground'>{t('jdLogs.pagination', { start: 1, end: 5, total: 128 })}</span>
              <div className='flex items-center gap-2'>
                <button className='w-10 h-10 flex items-center justify-center rounded-lg border border-border text-muted-foreground hover:text-primary hover:border-primary transition-all disabled:opacity-50' disabled>
                ...
                <button className='w-10 h-10 flex items-center justify-center rounded-lg border border-border text-muted-foreground hover:text-primary hover:border-primary transition-all'>2</button>
                <button className='w-10 h-10 flex items-center justify-center rounded-lg border border-border text-muted-foreground hover:text-primary hover:border-primary transition-all'>3</button>
                <span className='px-2 text-muted-foreground'>...</span>
                <button className='w-10 h-10 flex items-center justify-center rounded-lg border border-border text-muted-foreground hover:text-primary hover:border-primary transition-all'>26</button>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-6 pb-4'>
            <div className='bg-card p-6 rounded-xl shadow-sm border border-border flex items-center gap-4'>
              ...
              <div>
                <p className='text-xs text-muted-foreground font-bold uppercase tracking-wider'>{t('jdLogs.stats.totalProcessed')}</p>
            ...
            <div className='bg-card p-6 rounded-xl shadow-sm border border-border flex items-center gap-4'>
              ...
              <div>
                <p className='text-xs text-muted-foreground font-bold uppercase tracking-wider'>{t('jdLogs.stats.success24h')}</p>
            ...
            <div className='bg-card p-6 rounded-xl shadow-sm border border-border flex items-center gap-4'>
              ...
              <div>
                <p className='text-xs text-muted-foreground font-bold uppercase tracking-wider'>{t('jdLogs.stats.systemErrors')}</p>
