            ...
            <div className='grid grid-cols-1 md:grid-cols-4 gap-6'>
              <div className='space-y-2'>
                ...
                <div className='relative'>
                  <span className='material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground'>alternate_email</span>
                  <input
          ...
          <section className='bg-card rounded-xl overflow-hidden shadow-sm'>
              ...
              <table className='w-full text-left border-collapse'>
                ...
                <tbody className='divide-y divide-border'>
                  ...
                  <tr className='hover:bg-muted/30 transition-colors cursor-pointer'>
                    ...
                    <td className='px-6 py-5 text-right'>
                      <div className='flex items-center justify-end gap-2'>
                        <Link to='/admin/users/hoang.nguyen@gmail.com' className='p-2 hover:bg-muted rounded-lg text-primary transition-colors inline-flex items-center justify-center' title={t('users.table.viewAction')}>
                  ...
                  <tr className='hover:bg-muted/30 transition-colors cursor-pointer'>
                    ...
                    <td className='px-6 py-5 text-right'>
                      <div className='flex items-center justify-end gap-2'>
                        <Link to='/admin/users/minhtran.dev@outlook.com' className='p-2 hover:bg-muted rounded-lg text-primary transition-colors inline-flex items-center justify-center' title={t('users.table.viewAction')}>
                          <span className='material-symbols-outlined text-lg'>visibility</span>
                        </Link>
                  ...
                  <tr className='hover:bg-muted/30 transition-colors cursor-pointer'>
                    ...
                    <td className='px-6 py-5 text-right'>
                      <div className='flex items-center justify-end gap-2'>
                        <Link to='/admin/users/le.anh.92@edu.vn' className='p-2 hover:bg-muted rounded-lg text-primary transition-colors inline-flex items-center justify-center' title={t('users.table.viewAction')}>
                          <span className='material-symbols-outlined text-lg'>visibility</span>
                        </Link>
                        <button className='px-3 py-1.5 border border-primary text-primary rounded-lg text-xs font-bold hover:bg-primary hover:text-primary-foreground transition-all active:scale-95 whitespace-nowrap'>
                          {t('users.table.banAction')}
                  ...
                  <tr className='hover:bg-muted/30 transition-colors cursor-pointer'>
                    ...
                    <td className='px-6 py-5 text-right'>
                      <div className='flex items-center justify-end gap-2'>
                        <Link to='/admin/users/thao.pham@creative.co' className='p-2 hover:bg-muted rounded-lg text-primary transition-colors inline-flex items-center justify-center' title={t('users.table.viewAction')}>
                          <span className='material-symbols-outlined text-lg'>visibility</span>
                        </Link>
                        <button className='px-3 py-1.5 border border-primary text-primary rounded-lg text-xs font-bold hover:bg-primary hover:text-primary-foreground transition-all active:scale-95 whitespace-nowrap'>
                          {t('users.table.banAction')}
            ...
            <div className='p-6 border-t border-border flex flex-col md:flex-row gap-4 items-center justify-between'>
              ...
              <div className='flex gap-2'>
                ...
                <button className='px-4 py-2 hover:bg-muted rounded-lg font-medium transition-all'>
                  2
                </button>
                <button className='px-4 py-2 hover:bg-muted rounded-lg font-medium transition-all'>
                  3
