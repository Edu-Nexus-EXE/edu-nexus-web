          ...
          <div className='bg-card p-8 rounded-xl shadow-sm border border-border hover:border-primary/40 transition-colors flex flex-col group'>
            ...
            <div className='space-y-3 mb-6 flex-grow'>
              ...
              <div
                ...
                className={`flex items-center justify-between p-4 rounded-xl border cursor-pointer transition-all hover:shadow-sm ${selectedTest === 't1'
                  ? 'border-primary bg-primary/5 shadow-md shadow-primary/5'
                  : 'border-border hover:border-primary/50 hover:bg-muted/40'
                  }`}
              >
                <div className='flex items-center gap-3'>
                  <div className={`p-2 rounded-lg ${selectedTest === 't1' ? 'bg-primary/10 text-primary' : 'bg-muted text-muted-foreground'}`}>
                    <span className='material-symbols-outlined text-[20px]'>analytics</span>
                  </div>
                  <div className='text-sm font-semibold text-foreground'>{t('skillsTest.test.t1Name')}</div>
                </div>
                <span className={`text-[10px] font-bold px-2.5 py-1 rounded-full ${selectedTest === 't1' ? 'text-primary bg-primary/10' : 'text-muted-foreground bg-muted'
                  }`}>
