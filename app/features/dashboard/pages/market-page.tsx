...
const SCHOLARSHIPS: ScholarshipCardProps[] = [
  ...
  },
  {
    ...
    aiSuggestion: <>Cập nhật Portfolio dự án cá nhân lên Github để cải thiện điểm hồ sơ.</>
  },
  {
    id: '3',
    ...
    missing: ['TOEFL > 100'],
    aiSuggestion: <>Bạn gần như hoàn hảo! Chỉ cần cải thiện điểm TOEFL trong 2 tháng tới.</>
  }
]
