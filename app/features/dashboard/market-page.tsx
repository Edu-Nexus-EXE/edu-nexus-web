...
import { MarketCard, type ScholarshipCardProps } from './components/market-card'
...
const SCHOLARSHIPS: ScholarshipCardProps[] = [
  ...
  },
  {
    ...
    location: 'Remote',
    logo: <div className='w-9 h-9 rounded bg-red-800 flex items-center justify-center text-white font-serif font-bold text-xs'>H</div>,
    endsIn: '01 Month',
    matchPercent: 92,
