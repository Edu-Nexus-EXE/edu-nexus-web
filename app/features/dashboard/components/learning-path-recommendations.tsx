    ...
    <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 mt-12'>
      ...
      <div className='lg:col-span-2'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
          {/* Main Recommendation */}
          <div className='p-4 bg-gradient-to-br from-primary to-orange-600 rounded-xl text-white shadow-lg shadow-primary/20 relative overflow-hidden group'>
            ...
            <span className='inline-block px-2 py-1 bg-white/20 rounded text-[10px] font-bold uppercase mb-2'>
            ...
            <p className='text-white/80 text-xs mt-2 mb-4'>{t('learningPath.recommendations.microservicesDesc')}</p>
            <button type='button' className='bg-white text-primary px-4 py-2 rounded-lg text-xs font-bold hover:bg-slate-50 transition-colors'>
