...
const HISTORY_DATA: AnalysisRecord[] = [
  { id: '1', jobTitle: 'Kỹ sư Phần mềm', company: 'FPT Software', date: '15/10/2023', matchPercent: 85, icon: 'code', iconBg: 'bg-blue-500/10', iconColor: 'text-blue-500', barColor: 'bg-primary' },
  { id: '2', jobTitle: 'Data Analyst', company: 'Shopee Vietnam', date: '02/10/2023', matchPercent: 72, icon: 'data_usage', iconBg: 'bg-orange-500/10', iconColor: 'text-orange-500', barColor: 'bg-primary' },
  { id: '3', jobTitle: 'Frontend Developer', company: 'VNG Corporation', date: '20/09/2023', matchPercent: 90, icon: 'web', iconBg: 'bg-teal-500/10', iconColor: 'text-teal-500', barColor: 'bg-primary' },
  { id: '4', jobTitle: 'Product Management Intern', company: 'Grab', date: '05/09/2023', matchPercent: 45, icon: 'inventory_2', iconBg: 'bg-purple-500/10', iconColor: 'text-purple-500', barColor: 'bg-red-400' },
  { id: '5', jobTitle: 'DevOps Engineer', company: 'VNPT IT', date: '12/08/2023', matchPercent: 65, icon: 'cloud', iconBg: 'bg-indigo-500/10', iconColor: 'text-indigo-500', barColor: 'bg-primary' },
]
              ...
              <tr key={record.id} className='hover:bg-muted/30 transition-colors'>
                <td className='px-6 py-5'>
                  <div className='flex items-center gap-3'>
                    <div className={cn('size-8 rounded-lg flex items-center justify-center', record.iconBg, record.iconColor)}>
                ...
                <td className='px-6 py-5'>
                  <div className='flex items-center gap-4'>
                    <div className='flex-1 h-2 w-24 bg-muted rounded-full overflow-hidden'>
                      <div className={cn('h-full rounded-full', record.barColor)} style={{ width: `${record.matchPercent}%` }} />
                    </div>
                    <span className={cn('text-sm font-bold', record.matchPercent >= 50 ? 'text-primary' : 'text-red-500')}>
                      {record.matchPercent}%
                    </span>
                  </div>
                </td>
