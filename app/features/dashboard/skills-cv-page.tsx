...
export function SkillsCvPage() {
  ...
  return (
    <DashboardLayout>
      {/* Injecting custom styles for dotted border and animations as defined in the HTML */}
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .dotted-border {
            background-image: url("data:image/svg+xml,%3csvg width='100%25' height='100%25' xmlns='http://www.w3.org/2000/svg'%3e%3crect width='100%25' height='100%25' fill='none' rx='12' ry='12' stroke='%23f97316' stroke-width='2' stroke-dasharray='8%2c 12' stroke-dashoffset='0' stroke-linecap='square'/%3e%3c/svg%3e");
      ...
      <div className='relative w-full max-w-6xl mx-auto px-4 py-12'>
        ...
        <div className='absolute bottom-0 left-0 -z-10 w-[500px] h-[500px] bg-teal-accent/5 rounded-full blur-[100px] pointer-events-none opacity-40' />
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12'>
          ...
          <div className='bg-card p-8 rounded-xl shadow-sm border border-border hover:border-primary/40 transition-colors flex flex-col group'>
            ...
            <div className='flex-grow dotted-border flex flex-col items-center justify-center p-8 bg-muted/30 hover:bg-muted/50 transition-colors cursor-pointer group/drop'>
            ...
            <div className='mt-6 bg-muted/30 p-3 rounded-lg border border-border'>
              ...
              <div className='w-full bg-muted h-1.5 rounded-full overflow-hidden'>
                <div className='bg-gradient-to-r from-primary to-primary/60 h-full w-full shadow-[0_0_10px_rgba(249,115,22,0.3)]' />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className='flex flex-col items-center pb-10'>
          <button type='button' className='ai-glow group relative px-12 py-4 bg-gradient-to-r from-primary via-primary/80 to-primary bg-[length:200%_auto] animate-[gradient_2s_linear_infinite] text-primary-foreground font-bold text-lg rounded-xl hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center gap-3'>
